...
text = "_VOZEM_DO_NEHO_A_ZAS_MNE_BEZI_DO_CESTY__ZACHVELA_SE_TAK_KUDY_VPRAVO_NEBO_VLEVO_TEDY_JE_KONEC_PTAL_SE_TISE_POKYVLA_HLAVOU_TEDY" \
...
#abychom ziskali sifru textu z knihy, vygenerujeme nahodny klic
...
print(substitute_encrypt(text, random_key))
